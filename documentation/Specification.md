...
- Данный режим приложения позволяет просматривать список туров, а так же количества забронированных мест
  на каждый тур (отображаются колонки «№ Tour», «From/There», «Date tour», «Number of clients»).
 ![](media/1.png)
...
- Пользователь выбирает вкладку «Clients».

- Отображается форма просмотра списка клиентов. (в списке отображаются колонки «Firstname», «Lastname», «№ Tour»)
  ![](media/2.png)
